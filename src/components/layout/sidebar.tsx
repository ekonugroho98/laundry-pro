    ...
    <>
      ...
      <div className="md:hidden fixed top-4 left-4 z-50">
        <button 
          ...
          className="p-2 bg-[rgb(var(--swiss-paper-2))] border border-[rgb(var(--swiss-rule))] text-[rgb(var(--swiss-ink))] shadow-sm"
        >
      ...
      {/* Sidebar Container */}
      <div className={cn(
        "flex flex-col border-r border-[rgb(var(--swiss-rule))] bg-[rgb(var(--swiss-paper-2))] min-h-screen transition-transform duration-300 z-50",
